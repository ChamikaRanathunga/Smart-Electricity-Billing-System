...
public class newCustomer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 120, 370, 60));

        back.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 22)); // NOI18N
        back.setText("Back");
        back.setMaximumSize(new java.awt.Dimension(87, 33));
        back.setMinimumSize(new java.awt.Dimension(87, 33));
        back.setPreferredSize(new java.awt.Dimension(87, 33));
        back.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                backActionPerformed(evt);
            }
        });
        jPanel1.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 510, 140, 50));

        cinsert.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 22)); // NOI18N
        cinsert.setText("Register");
        cinsert.setMaximumSize(new java.awt.Dimension(87, 33));
        cinsert.setMinimumSize(new java.awt.Dimension(87, 33));
        cinsert.setPreferredSize(new java.awt.Dimension(87, 33));
        ...
        jPanel1.add(cinsert, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 510, 150, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Eda7O1.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 670, 540));
    ...
    private void cinsertMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cinsertMouseClicked
        //go to customer restration page
        cusReg c3 = new cusReg();
        c3.tableload();
