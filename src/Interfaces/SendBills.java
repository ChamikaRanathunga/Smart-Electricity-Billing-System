...
public class SendBills extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        time.setText("time");
        jPanel2.add(time, new org.netbeans.lib.awtextra.AbsoluteConstraints(1350, 10, 150, 30));
        ...
        jPanel3.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 100, 400, 410));
        ...
        sbilltype.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                sbilltypeKeyTyped(evt);
            }
        });
        jPanel3.add(sbilltype, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 170, 360, 50));
        ...
        jPanel3.add(sok, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 240, 120, 50));

        smessage.setFont(new java.awt.Font("Arial", 1, 26)); // NOI18N
        ...
        jPanel3.add(smessage, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 430, 430, 70));

        semail.setFont(new java.awt.Font("Arial", 1, 26)); // NOI18N
        ...
        jPanel3.add(semail, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 530, 430, 70));
        ...
        jPanel3.add(sback, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 650, 180, 60));
        ...
        jPanel7.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 270, 50));

        jPanel3.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 310, 300, 50));
        ...
        jPanel1.add(contact, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 0, 330, 50));

        jPanel3.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 310, 360, 50));
        ...
        jPanel6.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 210, 50));

        jPanel3.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 170, 250, 50));
        ...
        jPanel5.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 210, 50));

        jPanel3.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 100, 250, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/back2.png"))); // NOI18N
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1510, 860));

        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 1530, 780));
        ...
        date.setText("date");
        jPanel4.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 140, 30));

        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 10, 310, 30));
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 1530, 920));
    ...
    private void scidFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_scidFocusGained
        ...
        {
        scid.setText("");
        scid.setForeground(new Color(102,102,255));
        }       
    ...
    private void sbilltypeKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sbilltypeKeyTyped
       sbilltype.setForeground(Color.black);
    }//GEN-LAST:event_sbilltypeKeyTyped
    ...
    public static void main(String args[]) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SendBills.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
